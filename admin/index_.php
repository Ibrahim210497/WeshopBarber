...
<html>
<head>
    <title>SiteWeb Barber Shop 2021</title>
...
<div id="page" class="container">
    ...
    <section id="contenu">
        <div id="main">
            ...
            <?php
            if (isset($_SESSION['page']) && !isset($_SESSION['partie admin'])) {
                unset($_SESSION['page']);
                $_SESSION['partie admin '] = 1;
            }
...
<footer>
    <nav>
        <?php
        $path = "./lib/php/admin_footer.php";
        if (file_exists("./lib/php/admin_footer.php")) {
            require './lib/php/admin_footer.php';
        }
        ?>
    </nav>
</footer>
