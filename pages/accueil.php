...
<div class="container bg-dark">
    ...
    <div class="card text-center ">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner ">
                <div class="carousel-item active">
                    <img src="./admin/images/imgbarber2.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./admin/images/imgbarber.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./admin/images/imgbarber3.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
        ...
        <div>
            ...
            <h5 class="card-title text-dark"><strong>Soucieux de vous assurer les prestations des plus qualitatives, notre équipe travaille avec les meilleures marques du marché de la coiffure et de la barbe.</strong></h5>
        </div>
